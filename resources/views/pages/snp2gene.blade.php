    ...
    <div class="page-content inset">
      ...
      <div class="sidePanel container" style="padding-top:50px;" id="genomePlots">
        ...
        <div class="container">
          ...
          <span class="info"><i class="fa fa-info"></i>
            MAGMA gene-property analysis is performed for gene expression per tissue based on GTEx RNA-seq data.<br/>
            Expression values (RPKM) were log2 transformed with pseudocount 1 after winsorization at 50 and average was taken per tissue.
