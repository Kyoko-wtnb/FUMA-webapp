...
<script type="text/javascript" src="{!! URL::asset('js/browse.js') !!}"></script>
@stop
@section('content')
		...
		<div class="page-content inset">
			...
			<div class="sidePanel container" style="padding-top:50px;" id="genomePlots">
				...
				<div class="container">
					...
					<form method="post" target="_blank" action="{{ Config::get('app.subdir') }}/browse/imgdown">
						...
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane" id="geneTablePane">
								...
								<form action="{{ Config::get('app.subdir') }}/gene2func/geneSubmit" method="post" target="_blank">
									<input type="hidden" name="_token" value="{{ csrf_token() }}">
									<input type="hidden" name="id" value="<?php echo $gwasID;?>"/>
									<span class="form-inline">
							...
							<div id="annotPlotPanel">
								...
								<div style="margin-left: 40px;">
									<form action="annotPlot" method="post" target="_blank">
										...
										<input type="hidden" name="_token" value="{{ csrf_token() }}">
										<input type="hidden" name="id" value="<?php echo $gwasID;?>"/>
										<input type="hidden" name="prefix" value="gwas"/>
			...
			<div class="sidePanel container" style="padding-top:50px; height: 100vh;" id="downloads">
				...
				<form action="{{ Config::get('app.subdir') }}/browse/filedown" method="post" target="_blank">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<input type="hidden" name="id" value="<?php echo $gwasID;?>"/>
					<input type="hidden" name="prefix" value="gwas"/>
			...
			<!-- Expression heatmap -->
			<div class="sidePanel container" style="padding-top:50px;" id="expPanel">
	        ...
	        <div id="tsEnrichBarPanel"  class="sidePanel container" style="padding-top:50px;">
				...
				<form method="post" target="_blank" action="{{ Config::get('app.subdir') }}/browse/imgdown">
					...
					<input type="hidden" name="id" id="tsGeneralEnrichBarID" val=""/>
				...
				<form class="form-inline" action="g2fFileDown" method="post" target="_blank">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<input type="hidden" name="id" value="{{$gwasID}}"/>
				...
				<form method="post" target="_blank" action="{{ Config::get('app.subdir') }}/browse/imgdown">
					...
					<input type="hidden" name="id" id="tsEnrichBarID" val=""/>
				...
				<form action="g2fFileDown" method="post" target="_blank">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
					<input type="hidden" name="id" value="{{$gwasID}}"/>
	        ...
	        <div id="GeneSetPanel"  class="sidePanel container" style="padding-top:50px;">
				...
				<form method="post" target="_blank" action="{{ Config::get('app.subdir') }}/browse/imgdown">
					...
					<input type="hidden" name="id" id="GSID" val=""/>
