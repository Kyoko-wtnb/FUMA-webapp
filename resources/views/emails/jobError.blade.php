...
<p>
	...
	if($status==-1){
		...
		Please check the list of jobs from <a href="http://fuma.ctglab.nl/snp2gene">here</a> (login required).';
	}else if($status==1){
		...
		Please refer <a href="http://fuma.ctglab.nl/tutorial#prepare-input-files">Tutorial<a/> for details.<br/>';
	}else if($status==2){
		...
		Manhattan plots and significant top 10 SNPs in your input file are available from <a href="http://fuma.ctglab.nl/snp2gene/'.$jobID.'">SNP2GENE<a/>.<br/>';
	}else if($status==6){
		...
		Please refer <a href="http://fuma.ctglab.nl/tutorial#ciMap">Tutorial<a/> for details.<br/>';
	}else if($status==11){
