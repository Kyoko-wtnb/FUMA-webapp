...
<div style="padding-left: 40px;">
  ...
  Header can be anything (even just a new line is fine) but FUMA will start reading your genes from the second row.</p>
  ...
  File format should be the same as described for genes of interest.</p>
