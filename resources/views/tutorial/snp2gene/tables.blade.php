...
<ul>
  ...
  <ul>
    ...
    <li><strong>nSNPs</strong> : Number of the unique canidate SNPs in the genomic locus, including non-GWAS-tagged SNPs (which are extracted from 1000G).</li>
    <li><strong>nGWASSNPs</strong> : Number of the unique GWAS-tagged candidate SNPs in the genomic locus. This is a subset of &quot;nSNPs&quot;.</li>
    <li><strong>nIndSigSNPs</strong> : Number of the ind. isg. SNPs in the genomic locus.</li>
    <li><strong>IndSigSNPs</strong> : rsID of the ind. isg. SNPs in the genomic locus.</li>
    <li><strong>nLeadSNPs</strong> : Number of lead SNPs in the genomic locus.</li>
...
<ul>
  ...
  <ul>
    ...
    <li><strong>nIndSigSNPs</strong> : Number of ind. sig. SNPs wwhich are in LD of the lead SNP at r<sup>2</sup> 0.1.</li>
    <li><strong>IndSigSNPs</strong> : rsID of ind. sig. SNPs wwhich are in LD of the lead SNP at r<sup>2</sup> 0.1.</li>
  </ul>
  </li>
</ul>
<ul>
  <li><p>Ind. Sig. SNPs (Independent significant SNPs)</p>
  ...
  <ul>
    ...
    <li><strong>pos</strong> : position on hg19</li>
    <li><strong>P-value</strong> : P-value (from the input file).</li>
    <li><strong>nSNPs</strong> : Number of SNPs within LD of the lead SNP given r<sup>2</sup>, including non-GWAS-tagged SNPs (which are extracted from 1000G).</li>
    <li><strong>nGWASSNPs</strong> : Number of GWAS-tagged SNPs within LD of the lead SNP given r<sup>2</sup>. This is a subset of &quot;nSNPs&quot;.</li>
  </ul>
  </li>
</ul>
<ul>
  ...
  <ul>
    ...
    <li><strong>r2</strong> : The maximum r2 of the SNP with one of the ind. sig. SNP (this dosen't have to be either lead SNPs or the top lead SNPs in genomic risk loci).</li>
    <li><strong>IndSigSNP</strong> : rsID of the ind. sig. SNP which has the maximum r2 of the SNP.</li>
...
<ul>
  ...
  <ul>
    ...
    <li><strong>IndSigSNPs</strong> : rsID of the all ind. sig. SNPs of mapped SNPs.</li>
  </ul>
  </li>
</ul>
<ul>
