...
This allows users to turne gene mapping parameters without performing entire process again,
...
<div style="padding-left: 40px;">
	...
	Note that only jobs which are successed are selectable.
	...
	<br/>
	Users are allowed to provide new title and sufix "_copied_(jobID)" will be automatically
	added to the title.
	<br/>
	<span class="info"><i class="fa fa-info"></i>
		Users are only allowed to modify gene mapping parameters.
		Other parameters such as P-value or r2 threshould for defning independent significant SNPs
		can not be changed.
	</span>
	<h4><strong>3. Submit</strong></h4>
	User can submit the job by clicking the button at the bottom of the page.
	After submittion, the process is same as submitting a new SNP2GENE job,
