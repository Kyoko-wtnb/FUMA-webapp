...
<div style="padding-left: 40px">
	...
	Relaxing ther threshold for the genome-wide significant P-value results in an increased number of ind. sig. SNPs.
	...
	The most left and morst right SNPs which are in LD of a ind. sig. SNP define a LD block in which those SNPs are used to compute distance between LD blocks.<br/>
	Note that not all SNPs are necessary in LD with lead SNPs, althought they must be in LD with ind. sig. SNPs at the user defined r<sup>2</sup>.<br/>
