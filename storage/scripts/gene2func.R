...
source(paste(filedir, "../../scripts/GeneSet.R", sep="")) #local #local
...
load(paste(filedir, "../../data/entrez2mim.RData", sep="")) #local #local
#webserver load("/data/genes/entrez2mim.RData")

load(paste(filedir, "../../data/entrez2uniprot.RData", sep="")) #local #local
...
load(paste(filedir, "../../data/DrugBank.RData", sep="")) #local #local
