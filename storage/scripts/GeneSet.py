...
with open(filedir + "geneset_py_start.log", "w") as f:
	f.write("In GeneSet.py")

logging.basicConfig(filename=filedir + "geneset_py.log",
	filemode='a',
...
logging.info("Start logging geneSet.py")
...
try:
	...
	logging.exception("Exception in GeneSet.py: ")
