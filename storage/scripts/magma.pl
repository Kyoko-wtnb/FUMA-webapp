...
my $ref = "/media/sf_SAMSUNG/MAGMA/g1000_".$pop."_146"; #local #local
#webserver my $ref = "/data/MAGMA/g1000_".lc($pop)."_146";
system "awk 'NR>=2' $outSNPs | cut -f 5,6 | sort -u -k 1,1 > $magmain";
system "magma --bfile $ref --pval $magmain N=$N --gene-annot /media/sf_Documents/VU/Data/MAGMA/ENSG.w0.$pop.genes.annot --out $filedir"."magma"; #local #local
