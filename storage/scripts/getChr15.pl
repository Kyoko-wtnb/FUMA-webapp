...
if($cells[0] eq 'all'){
  @cells = `ls /media/sf_Documents/VU/Data/Chr15States/States/*.bed.gz`; #local #local
...
foreach my $cell (sort @cells){
  my $file="/media/sf_Documents/VU/Data/Chr15States/States/$cell\_core15.bed.gz"; #local #local
